...
class Rol
{
     ...
     * Add usuario
     *
     * @param \ERP\CRMBundle\Entity\Usuario $usuario
     * @return Rol
     */
    public function addUsuario(\ERP\CRMBundle\Entity\Usuario $usuario)
    {
     ...
     * @param \ERP\CRMBundle\Entity\Usuario $usuario
     */
    public function removeUsuario(\ERP\CRMBundle\Entity\Usuario $usuario)
    {
